                    ...
                    <li class="bg-light">
                      <a href="#">
                        <div class="contacts-list-info">
                          ...
                          <span class="contacts-list-msg">Gracias maestra.</span>
                        </div>
                        <!-- /.contacts-list-info -->
                      </a>
                    </li>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    ¿Qué tal maestra? Tengo una duda sobre la actividad.
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                  ...
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-right"><?php echo $_SESSION['Nombres'], " ", $_SESSION['ApellidoPaterno'], " ", $_SESSION['ApellidoMaterno'];?></span>
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      ...
                      <span class="direct-chat-timestamp float-right">2:08 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
